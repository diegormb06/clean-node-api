...
API desenvolvida utilizando TDD (programação orientada a testes) como metodologia de trabalho, Clean Architecture para fazer a distribuição de responsabilidades em camadas seguindo os princípios do SOLID.
...
API desenvolvida como parte do treinamento do professor Rodrigo Manguinho (Mango) na Udemy.
